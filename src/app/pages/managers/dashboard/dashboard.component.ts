...
import { IAppState, loadCutsCount, loadClientsCount, loadReadingsCount, loadInvoicesCount, loadInvoicesByZone } from "src/app/store";
...
// chart-options.model.ts (opcional)
import {
  ApexAxisChartSeries,
  ApexChart,
  ApexXAxis,
...
export class DashboardComponent implements OnInit, OnDestroy { // Ensure OnDestroy is implemented
  ...
  private refreshInterval = 120000; // Refresh data every 2 minutes
